...
import geogebra.geogebramobile.client.kernel.roots.RealRootUtil;
	...
	final public void draw(/*AGGraphics2D g2*/) {
        if (isVisible) {         	        	
            if (geo.doHighlighting()) {
                ...
                drawWithValueStrokePure(gp/*AG, g2*/);		                
            } 
        	...
        	if (fillCurve) {
				try {
					...
					fill(/*AGg2, */gp, false); // fill using default/hatching/image as appropriate
