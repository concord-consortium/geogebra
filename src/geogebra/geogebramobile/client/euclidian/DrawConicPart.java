...
import geogebra.geogebramobile.client.kernel.AlgoConicPartCircle;
import geogebra.geogebramobile.client.kernel.AlgoConicPartCircumcircle;
import geogebra.geogebramobile.client.kernel.AlgoSemicircle;
...
implements Previewable {
        	...
        	switch (draw_type) {
        		case DRAW_TYPE_ELLIPSE:
					if (geo.alphaValue > 0.0f) {
						//AGg2.setColor(geo.getFillColor());
						//AGg2.fill(shape);
		            ...
		            if (labelVisible) {
		            	...
		            	view.setFont(view.getFont());
						drawLabel(/*AGg2*/);
		            }		
		            break;
        	
        		case DRAW_TYPE_SEGMENT:        
        			drawSegment.draw(/*AGg2*/);
        			break;
	...
	final void drawTrace(/*AGGraphics2D g2*/) {
		switch (draw_type) {
			...
			case DRAW_TYPE_SEGMENT:
    			drawSegment.drawTrace(/*AGg2*/);
    			break;
    			
			case DRAW_TYPE_RAYS:
    			drawRay1.setStroke(objStroke);
    			drawRay2.setStroke(objStroke);
    			drawRay1.drawTrace(/*AGg2*/);
    			drawRay2.drawTrace(/*AGg2*/);
    			break;
		}
	}
