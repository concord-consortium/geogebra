...
import geogebra.geogebramobile.client.kernel.GeoRay;
...
import geogebra.geogebramobile.client.kernel.HasTimerAction;
import geogebra.geogebramobile.client.kernel.Kernel;
import geogebra.geogebramobile.client.kernel.ParametricCurve;
import geogebra.geogebramobile.client.kernel.View;
import geogebra.geogebramobile.client.kernel.gawt.AffineTransform;
import geogebra.geogebramobile.client.kernel.gawt.Arc2D;
import geogebra.geogebramobile.client.kernel.gawt.BasicStroke;
import geogebra.geogebramobile.client.kernel.gawt.Ellipse2D;
import geogebra.geogebramobile.client.kernel.gawt.Font;
import geogebra.geogebramobile.client.kernel.gawt.Line2D;
import geogebra.geogebramobile.client.kernel.gawt.Path2D;
import geogebra.geogebramobile.client.kernel.gawt.PathIterator;
import geogebra.geogebramobile.client.kernel.gawt.Point;
import geogebra.geogebramobile.client.kernel.gawt.QuadCurve2D;
import geogebra.geogebramobile.client.kernel.gawt.Rectangle;
import geogebra.geogebramobile.client.kernel.gawt.Shape;
...
//import geogebra.geogebramobile.client.kernel.gawt.Arc2D.Double;
...
//	 Michael Borcherds 2008-04-28 
	...
	*/
	public native void fillText(String text, int x, int y, String fullFontString) /*-{
		if (!@geogebra.geogebramobile.client.euclidian.EuclidianController::navigator_iPad) {	
	...
	public void setGridColor(geogebra.geogebramobile.client.kernel.gawt.Color  gridColor) {
	...
	protected Drawable createDrawable(GeoElement geo) {
		...
		case GeoElement.GEO_CLASS_ANGLE:
			if (geo.isIndependent()) {
				...
				if (geo.isDrawable()) {
					if (!geo.isColorSet()) {
						geogebra.geogebramobile.client.kernel.gawt.Color col = geo.getConstruction()
		...
		case GeoElement.GEO_CLASS_NUMERIC:
			...
			if (d != null) {
				if (!geo.isColorSet()) {
					...
					if (geo.isIndependent()) {
						geogebra.geogebramobile.client.kernel.gawt.Color col = consDef.getDefaultGeo(
...
/*AG
	...
	public void setPaint(
			geogebra.geogebramobile.client.kernel.gawt.Color color) {
	...
	public void setAxesColor(
			geogebra.geogebramobile.client.kernel.gawt.Color axesColor) {
		if (axesColor != null)
...
//	 Michael Borcherds 2008-04-11
	...
	public void setBackground(
			geogebra.geogebramobile.client.kernel.gawt.Color bgColor) {
		if (bgColor != null)
