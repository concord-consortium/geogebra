...
import geogebra.geogebramobile.client.euclidian.clipping.ClipShape;
import geogebra.geogebramobile.client.kernel.AlgoCirclePointRadius;
import geogebra.geogebramobile.client.kernel.AlgoCircleThreePoints;
import geogebra.geogebramobile.client.kernel.AlgoCircleTwoPoints;
import geogebra.geogebramobile.client.kernel.AlgoEllipseFociPoint;
import geogebra.geogebramobile.client.kernel.AlgoHyperbolaFociPoint;
...
import geogebra.geogebramobile.client.kernel.gawt.RectangularShape;
...
//		 Application.debug("step = " + step + "\n");		
	...
	final public void drawTrace(/*AGGraphics2D g2*/) {             
		...
		switch (type) {
			case GeoConic.CONIC_SINGLE_POINT:                         
				drawPoint.drawTrace(/*AGg2*/);
				break;     
                
			case GeoConic.CONIC_INTERSECTING_LINES:
			case GeoConic.CONIC_DOUBLE_LINE: 
			case GeoConic.CONIC_PARALLEL_LINES:
				drawLines[0].drawTrace(/*AGg2*/);
				drawLines[1].drawTrace(/*AGg2*/);
				break;             
