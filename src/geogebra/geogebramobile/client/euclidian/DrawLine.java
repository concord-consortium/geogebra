...
public final class DrawLine extends Drawable implements Previewable {
    ...
    final public void update() {  
        ...
        if (isVisible) {
            ...
            // line on screen?		
    		if (!line.intersects( -EuclidianView.CLIP_DISTANCE,  -EuclidianView.CLIP_DISTANCE, view.getOffsetWidth() + EuclidianView.CLIP_DISTANCE, view.getOffsetHeight() + EuclidianView.CLIP_DISTANCE)) {				
    			isVisible = false;
    ...
    // first calc two points in screen coords that are on the line
        ...
        if (Math.abs(gx) * view.scaleRatio < Math.abs(gy)) {
            ...
            y1 = k * x1 + d;            
            x2 = view.getOffsetWidth() + EuclidianView.CLIP_DISTANCE;
            y2 = k * x2 + d; 
            p1Pos = LEFT;
            p2Pos = RIGHT;            
            clipTopBottom();
        ...
        // y1 = height, y2 = 0
            ...
            y1 = view.getOffsetHeight() + EuclidianView.CLIP_DISTANCE;   
            x1 = k * y1 + d;
    ...
    final private void clipTopBottom() {
        ...
        attr1[BOTTOM]   = y1 > view.getOffsetHeight() + EuclidianView.CLIP_DISTANCE;                
        attr2[TOP]      = y2 < -EuclidianView.CLIP_DISTANCE;
        attr2[BOTTOM]   = y2 > view.getOffsetHeight() + EuclidianView.CLIP_DISTANCE;
        ...
        // point2 BOTTOM -> clip with y=height
            ...
            y2 = view.getOffsetHeight() + EuclidianView.CLIP_DISTANCE;
            x2 = (y2 - d)/k;             
            p2Pos = BOTTOM;
        }        
    }    
    ...
    final private void clipLeftRight() {
        ...
        attr1[RIGHT]    = x1 > view.getOffsetWidth() + EuclidianView.CLIP_DISTANCE;                
        attr2[LEFT]     = x2 < -EuclidianView.CLIP_DISTANCE;
        attr2[RIGHT]    = x2 > view.getOffsetWidth() + EuclidianView.CLIP_DISTANCE;
        ...
        // point1 RIGHT -> clip with x=width
            ...
            x1 = view.getOffsetWidth() + EuclidianView.CLIP_DISTANCE;
            y1 = (x1 - d)/k;             
            p1Pos = RIGHT;
        }
    ...
    final private void setLabelPosition() {                      
        ...
        switch (labelPos) {
            ...
            case RIGHT:        
                xLabel = view.getOffsetWidth() - 15;
                if (2*y < view.getOffsetHeight()) {
                    yLabel = y + 16 - (int)(16 * (gx / gy));
                } else {
                    yLabel = y - 8 - (int)(16 * (gx / gy));
                }
