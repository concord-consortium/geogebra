...
import geogebra.geogebramobile.client.kernel.gawt.Dimension;
...
// Michael Borcherds 2007-10-18 END
	...
	final public void draw(/*AGGraphics2D g2*/) {
		...
		if (isVisible) {		
			...
			view.setStroke(EuclidianView.getDefaultStroke()); 
			
			checkBoxIcon.paintIcon(geoBool.getBoolean(), geoBool.doHighlighting(), view, geoBool.labelOffsetX + 5, geoBool.labelOffsetY + 5);
			
			view.setPaint(geo.getObjectColor());
			view.setStroke(geo.getObjectColor());
			textSize = Drawable.drawIndexedString(view,labelDesc, geoBool.labelOffsetX + size + 9, geoBool.labelOffsetY + (size + 9) / 2 + 5);
	...
	public static class CheckBoxIcon {
        ...
        public void paintIcon(boolean checked, boolean highlighted, EuclidianView g, int x, int y) {
                ...
                if (true) {
                   ...
                   //AG g.setColor(Color.WHITE);
                    ...
                    if (highlighted) {
                        ...
                        g.setStroke(highlightBackground);
                        g.setPaint(highlightBackground);
                    } else {
                    ...
                    //g.setColor(UIManager.getColor("CheckBox.shadow"));
                    g.setStroke(new Color(128,128,128));
                    g.rect(x + 1, y + 1, csize - 3, csize - 3);
