...
/*AG	}
	 ...
	 */
/*AG	private void setInitialScaling() {
		if (allowRescaling) {			
...
//AG FOR GGJSVIEWER WE ONLY NEED FROM HERE
     */
	 ...
	 */
	/*AGpublic synchronized byte [] getGGBfile() {
