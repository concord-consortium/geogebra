...
Translateable,PointRotateable, Mirrorable, Dilateable, LineProperties {
     ...
     */
    /*AGfinal public boolean isDefinedTangent(GeoConic c) {        
     ...
     */
    /*AGfinal public boolean isDefinedAsymptote(GeoConic c) {        
 ...
 ***********************************************************/
   ...
   /**
	...
	/*AGprivate class PathMoverLine extends PathMoverGeneric {
