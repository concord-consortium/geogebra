...
public class GeoList extends GeoElement implements ListValue, LineProperties, PointProperties, TextProperties {
    ...
    public void set(GeoElement geo) {    	
		...
		//AG	AlgoMacro algoMacro = (AlgoMacro) getParentAlgorithm();
		//AG	algoMacro.initList(l, this);			
		} 
		else {
			// STANDARD CASE
			// copy geoList                
   ...
   public MyList getMyList() {
	...
	/**
	  ...
	  public final String getXML() {
		...
		public int pointSize = EuclidianViewConstants.DEFAULT_POINT_SIZE; 
