...
import geogebra.geogebramobile.client.cas.GeoGebraCAS;
import geogebra.geogebramobile.client.io.MyXMLHandler;
import geogebra.geogebramobile.client.kernel.arithmetic.Equation;
import geogebra.geogebramobile.client.kernel.arithmetic.ExpressionNode;
import geogebra.geogebramobile.client.kernel.arithmetic.ExpressionNodeEvaluator;
...
public class Kernel {
	...
	public Kernel() {
		//AGnf = NumberFormat.getInstance(Locale.ENGLISH);
		//AGnf.setGroupingUsed(false);
	...
	*/
     ...
     */ 
	/*AGfinal public String evaluateJASYMCA(String exp) {
		if (ggbCAS == null) {
			getGeoGebraCAS();		
		}				
     ...
     * @return result string (null possible)
     */
	/*AGfinal public String evaluateMathPiper(String exp) {
		if (ggbCAS == null) {
			getGeoGebraCAS();		
		}
     ...
     * ["0", "b", "3*a"]
     */
    /*AGfinal public String [] getPolynomialCoeffs(String exp, String variable) {
    	if (ggbCAS == null) {
    		//getGeoGebraCAS();					
		}
	...
	final public void setEpsilon(double epsilon) {
		...
		//AGgetEquationSolver().setEpsilon(EPSILON);
	}
	...
	/*AGfinal public int getMaximumFractionDigits() {
	...
	final public void setPrintFigures(int figures) {
		if (figures >= 0) {
			...
			//AGsf.setSigDigits(figures);
			//AGsf.setMaxWidth(16); // for scientific notation
	...
	private void storeTemporaryRoundingInfoInList()
	{
		...
		noOfSignificantFiguresList.push(new Integer(0/*AGsf.getSigDigits()*/));	
		noOfDecimalPlacesList.push(new Integer(0/*AGnf.getMaximumFractionDigits()*/));	
	}
     ...
     */
    public GeoElement createGeoElement(Construction cons, String type) throws Error {//AG {    	
	...
	public boolean handleCoords(GeoElement geo, LinkedHashMap<String, String> attrs) {
		...
		if (!(geo instanceof GeoVec3D)) {
			BaseApplication.debug("wrong element type for <coords>: "
					+ geo.getClass());
			return false;
		}
	...
	public void storeUndoInfo() {
		if (undoActive) {
			//AGcons.storeUndoInfo();
		}
	}

	public void restoreCurrentUndoInfo() {
		//AGif (undoActive) cons.restoreCurrentUndoInfo();
	}

	public void initUndoInfo() {
		//AGif (undoActive) cons.initUndoInfo();
	}
	...
	public boolean undoPossible() {
		return false; //AGundoActive && cons.undoPossible();
	}

	public boolean redoPossible() {
		return false; //AG undoActive && cons.redoPossible();
	}
	 ...
	 * e.g. A1:B2
	 */
	/*AGfinal public GeoList CellRange(String label, GeoElement startCell, GeoElement endCell) {
		AlgoCellRange algo =
	 ...
	 */
	/*AGfinal public GeoElement [] Sequence(String label, 
	 ...
	 */
	/*AGfinal public GeoElement Cell(
		String label,
	 ...
	 * ColumnName[]
	 */
	/*AGfinal public GeoText ColumnName(
		String label,
		GeoElement geo) {
	...
	*/
	 ...
	 * Column of geo.
	 */
	/*AGfinal public GeoNumeric Column(
		String label,
		GeoElement geo) {
	 ...
	 * ToNumber
	 */
	/*AGfinal public GeoNumeric LetterToUnicode(
		String label,
		GeoText geo) {
	...
	*/
	 ...
	 * ToNumbers
	 */
	/*AGfinal public GeoList TextToUnicode(
		String label,
		GeoText geo) {
	 ...
	 * ToText(number)
	 */
	/*AGfinal public GeoText UnicodeToLetter(String label, NumberValue a) {
	 ...
	 * ToText(list)
	 */
	/*AGfinal public GeoText UnicodeToText(
		String label,
		GeoList geo) {
	 ...
	 * Michael Borcherds 
	 */
	/*AGfinal public GeoNumeric AxisStepX(
		String label) {
	...
	*/
	 ...
	 * Michael Borcherds 
	 */
	/*AGfinal public GeoNumeric AxisStepY(
		String label) {
	...
	*/
	 ...
	 */
	/*AGfinal public GeoNumeric ConstructionStep(
		String label) {
	...
	*/
	...
	final public GeoPoint PointIn(String label, Region region, double x, double y) {
		...
		//AGApplication.debug("PointIn - \n x="+x+"\n y="+y);
		GeoPoint p = algo.getP();    
		return p;
	}
	
	/** Point in region */
	/*AGfinal public GeoPoint PointIn(String label, Region region) {  
		return PointIn(label,region,0,0); //TODO do as for paths
	}	
	*/
	/** Point P + v   */
	/*AGfinal public GeoPoint Point(String label, GeoPoint P, GeoVector v) {
		AlgoPointVector algo = new AlgoPointVector(cons, label, P, v);
		GeoPoint p = algo.getQ();        
		return p;
	}*/
	 ...
	 */
	/*AGfinal public GeoPoint ProjectedPoint(GeoPoint P, GeoLine g) {
	...
	*/
	 ...
	 * BarChart	
	 */
	/*AGfinal public GeoNumeric BarChart(String label, 
	 ...
	 * BoxPlot
	 */
	/*AGfinal public GeoNumeric BoxPlot(String label, 
	...
	//AG	AlgoBoxPlot algo = new AlgoBoxPlot(cons, label, a, b, rawData);
		
		
	//AG	GeoNumeric sum = algo.getSum();
	//AG	return sum;
	//AG}
	 ...
	 * Histogram
	 */
	/*AGfinal public GeoNumeric Histogram(String label, 
					GeoList list1, GeoList list2) {
	 ...
	 */
	/*AGfinal public GeoNumeric UpperSum(String label, GeoFunction f, 
	 ...
	 */
	/*AGfinal public GeoNumeric TrapezoidalSum(String label, GeoFunction f, 
					NumberValue a, NumberValue b, NumberValue n) {
	 ...
	 */
	/*AGfinal public GeoNumeric LowerSum(String label, GeoFunction f, 
					NumberValue a, NumberValue b, NumberValue n) {
	...
	*/
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoLine FitLineY(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoLine FitLineX(String label, GeoList list) {
	 ...
	 * Hans-Petter Ulven
	 */
	/*AGfinal public GeoFunction FitPoly(String label, GeoList list, NumberValue degree) {
	 ...
	 * Hans-Petter Ulven
	 */
	/*AGfinal public GeoFunction FitExp(String label, GeoList list) {
	 ...
	 * Hans-Petter Ulven
	 */
	/*AGfinal public GeoFunction FitLog(String label, GeoList list) {
	 ...
	 * Hans-Petter Ulven
	 */
	/*AGfinal public GeoFunction FitPow(String label, GeoList list) {
	 ...
	 * Hans-Petter Ulven
	 */
	/*AGfinal public GeoFunction FitSin(String label, GeoList list) {
	 ...
	 * Hans-Petter Ulven
	 */
	/*AGfinal public GeoFunction FitLogistic(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoNumeric InverseNormal(String label, NumberValue a, NumberValue b, NumberValue c) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoNumeric Normal(String label, NumberValue a, NumberValue b, NumberValue c) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoNumeric TDistribution(String label, NumberValue a, NumberValue b) {
		AlgoTDistribution algo = new AlgoTDistribution(cons, label, a, b);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseTDistribution(String label, NumberValue a, NumberValue b) {
		AlgoInverseTDistribution algo = new AlgoInverseTDistribution(cons, label, a, b);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	/*AGfinal public GeoNumeric ChiSquared(String label, NumberValue a, NumberValue b) {
		AlgoChiSquared algo = new AlgoChiSquared(cons, label, a, b);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseChiSquared(String label, NumberValue a, NumberValue b) {
		AlgoInverseChiSquared algo = new AlgoInverseChiSquared(cons, label, a, b);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	/*AGfinal public GeoNumeric Exponential(String label, NumberValue a, NumberValue b) {
		AlgoExponential algo = new AlgoExponential(cons, label, a, b);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseExponential(String label, NumberValue a, NumberValue b) {
		AlgoInverseExponential algo = new AlgoInverseExponential(cons, label, a, b);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric FDistribution(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoFDistribution algo = new AlgoFDistribution(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseFDistribution(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoInverseFDistribution algo = new AlgoInverseFDistribution(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric Gamma(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoGamma algo = new AlgoGamma(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseGamma(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoInverseGamma algo = new AlgoInverseGamma(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric Cauchy(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoCauchy algo = new AlgoCauchy(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseCauchy(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoInverseCauchy algo = new AlgoInverseCauchy(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric Weibull(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoWeibull algo = new AlgoWeibull(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseWeibull(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoInverseWeibull algo = new AlgoInverseWeibull(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric Zipf(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoZipf algo = new AlgoZipf(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseZipf(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoInverseZipf algo = new AlgoInverseZipf(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric Pascal(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoPascal algo = new AlgoPascal(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InversePascal(String label, NumberValue a, NumberValue b, NumberValue c) {
		AlgoInversePascal algo = new AlgoInversePascal(cons, label, a, b, c);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric HyperGeometric(String label, NumberValue a, NumberValue b, NumberValue c, NumberValue d) {
		AlgoHyperGeometric algo = new AlgoHyperGeometric(cons, label, a, b, c, d);
		GeoNumeric num = algo.getResult();
		return num;
	}*/
	
	/*AGfinal public GeoNumeric InverseHyperGeometric(String label, NumberValue a, NumberValue b, NumberValue c, NumberValue d) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList First(String label, GeoList list, GeoNumeric n) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Last(String label, GeoList list, GeoNumeric n) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Append(String label, GeoList list, GeoElement geo) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Append(String label, GeoElement geo, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Join(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Union(String label, GeoList list, GeoList list1) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList SetDifference(String label, GeoList list, GeoList list1) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Insert(String label, GeoElement geo, GeoList list, GeoNumeric n) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList RemoveUndefined(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoBoolean Defined(String label, GeoElement geo) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Invert(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoList Transpose(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoNumeric Determinant(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement Sum(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement Sum(String label, GeoList list, GeoNumeric n) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement SumFunctions(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement SumFunctions(String label, GeoList list, GeoNumeric num) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement SumPoints(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement SumPoints(String label, GeoList list, GeoNumeric num) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement SumText(String label, GeoList list) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoElement SumText(String label, GeoList list, GeoNumeric num) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoText TableText(String label, GeoList list, GeoText args) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoText FractionText(String label, GeoNumeric num) {
	 ...
	 * Michael Borcherds
	 */
	/*AGfinal public GeoNumeric StandardDeviation(String label, GeoList list) {
	 ...
	 * Iteration[ f(x), x0, n ] 
	 */
	/*AGfinal public GeoNumeric Iteration(String label, GeoFunction f, NumberValue start,
			NumberValue n) {
	 ...
	 */
	/*AGfinal public GeoList IterationList(String label, GeoFunction f, NumberValue start,
			NumberValue n) {
	 ...
	 * Element[list, number]
	 */
	/*AGfinal public GeoElement Element(String label, GeoList list, NumberValue n) {
	 ...
	 */
	/*AGfinal public GeoElement Element(String label, GeoList list, NumberValue n, NumberValue m) {
	 ...
	 */
	/*AGfinal public GeoNumeric Perimeter(String label, GeoPolygon polygon) {
	 ...
	 */
	/*AGfinal public GeoNumeric Circumference(String label, GeoConic conic) {
	 ...
	 */
	/*AGfinal public GeoPoint[] Vertex(String[] labels, GeoConic c) {
	 ...
	 * Corner of image
	 */
	/*AGfinal public GeoPoint Corner(String label, GeoImage img, NumberValue number) {
	 ...
	 */
	/*AGfinal public GeoPoint Corner(String label, GeoText txt, NumberValue number) {
	 ...
	 */
	/*AGfinal public GeoPoint CornerOfDrawingPad(String label, NumberValue number) {
	 ...
	 * of polynomials a, b
	 */
	/*AGfinal public GeoPoint[] IntersectPolynomials(String[] labels, GeoFunction a, GeoFunction b) {
	 ...
	 */
	/*AGfinal public GeoPoint[] IntersectPolynomialLine(
			String[] labels,		
			GeoFunction f,
			GeoLine l) {
	 ...
	 * first axis of c
	 */
	/*AGfinal public GeoLine FirstAxis(String label, GeoConic c) {
	 ...
	 */
	/*AGfinal public GeoElement [] Dilate(String label, Dilateable geoRot, NumberValue r, GeoPoint S) {
		if (label == null)
			label = transformedGeoLabel(geoRot.toGeoElement());
...
//				((Orientable)geos[0]).setOppositeOrientation( (Orientable)geoMir);
	 ...
	 * dilate geoRot by r from S
	 */
	/*AGfinal public GeoElement [] Dilate(String label, GeoPolygon poly, NumberValue r, GeoPoint S) {
		return transformPoly(label, poly, dilatePoints(poly.getPoints(), r, S));
	}/*
	
	/*AGGeoPoint [] dilatePoints(GeoPoint [] points, NumberValue r, GeoPoint S) {		
		// dilate all points
		GeoPoint [] newPoints = new GeoPoint[points.length];
		for (int i = 0; i < points.length; i++) {
			String pointLabel = transformedGeoLabel(points[i]);
	 ...
	 */
	/*AGfinal public GeoFunction PolynomialFunction(String label, GeoFunction f) {		
	 ...
	 */
	/*AGfinal public GeoFunction PolynomialFunction(String label, GeoList list) {		
	 ...
	 */
	/*AGfinal public GeoElement Expand(String label, GeoFunction func) {		
	 ...
	 * @author Michael Borcherds 2008-04-04
	 */
	/*AGfinal public GeoElement Simplify(String label, GeoFunction func) {		
	 ...
	 */
	/*AGfinal public GeoFunction Factor(String label, GeoFunction func) {		
	 ...
	 */
	/*AGfinal public GeoFunction TaylorSeries(
		String label,
		GeoFunction f,
		NumberValue a, 
		NumberValue n) {
	 ...
	 */
	/*AGfinal public GeoPoint [] Root(String [] labels, GeoFunction f) {
	 ...
	 */
	/*AGfinal public GeoPoint Root(String label, GeoFunction f, NumberValue a) {			 
	 ...
	 */
	/*AGfinal public GeoPoint Root(String label, GeoFunction f, NumberValue a, NumberValue b) {			 
	 ...
	 */
	/*AGfinal public GeoPoint [] Extremum(String [] labels, GeoFunction f) {
	 ...
	 */
	/*AGfinal public GeoPoint [] TurningPoint(String [] labels, GeoFunction f) {
		//	check if this is a polynomial at the moment
		if (!f.isPolynomialFunction(true)) return null;
	...
	/*AGfinal public GeoNumeric AffineRatio(String label, GeoPoint A, GeoPoint B,
			GeoPoint C) {
	...
	/*AGfinal public GeoNumeric CrossRatio(String label,GeoPoint A,GeoPoint B,GeoPoint C,GeoPoint D){
	...
	/*AGfinal public GeoVector CurvatureVector(String label,GeoPoint A,GeoFunction f){
	...
	/*AGfinal public GeoVector CurvatureVectorCurve(String label,GeoPoint A,GeoCurveCartesian f){
	...
	/*AGfinal public GeoNumeric Curvature(String label,GeoPoint A,GeoFunction f){
	...
	/*AGfinal public GeoNumeric CurvatureCurve(String label,GeoPoint A, GeoCurveCartesian f){
	...
	/*AGfinal public GeoConic OsculatingCircle(String label,GeoPoint A,GeoFunction f){
	...
	/*AGfinal public GeoConic OsculatingCircleCurve(String label,GeoPoint A,GeoCurveCartesian f){
	...
	/*AGfinal public boolean isReal(Complex c) {
			...
			case ExpressionNode.STRING_TYPE_JASYMCA:		
				if (Double.isNaN(x))
					...
					// number would produce E notation with Double.toString()
						...
						// TODO: remove
						BaseApplication.printStacktrace(sb.toString());
	 ...
	 * returned as "0.123".
	 */
	/*AGfinal private String formatSF(double x) {
		if (sbFormatSF == null)
	...
	/*AGfinal public String formatPiE(double x, NumberFormat numF) {		
		// PI
		if (x == Math.PI) {
			return casPrintFormPI;
		}
	...
	public String getKernelXML() {
		...
		else
		{
			...
			sb.append("AGKermel6052"/*AGgetPrintDecimals()*/);
			sb.append("\"/>\n");
		}
...
final public ExpressionNode handleTrigPower(String image, ExpressionNode en, int type) {
	...
	public synchronized Object getGeoGebraCAS() {
		if (ggbCAS == null) {
			ggbCAS = new geogebra.geogebramobile.client.cas.GeoGebraCAS(this);
		}			
	...
	final public String evaluateMathPiper(String exp) {
		...
		return ((geogebra.geogebramobile.client.cas.GeoGebraCAS) ggbCAS).evaluateMathPiper(exp);
	}	
	...
	final public String evaluateGeoGebraCAS(String exp) throws Throwable {
		...
		return ((geogebra.geogebramobile.client.cas.GeoGebraCAS) ggbCAS).evaluateGeoGebraCAS(exp);
	}	
    ...
    final public String [] getPolynomialCoeffs(String exp, String variable) {
    	...
    	return ((geogebra.geogebramobile.client.cas.GeoGebraCAS) ggbCAS).getPolynomialCoeffs(exp, variable);
    }
