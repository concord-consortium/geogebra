...
public class AlgoCasDerivative extends AlgoCasBase {
    ...
    final public String toString() {
        ...
        if (var != null) {
	        ...
	        if (order != null)
	        	sb.append(bApp.getPlain("AthDerivativeOfB", order.toGeoElement().getLabel(),f.toGeoElement().getLabel()));
	        else
	        	sb.append(bApp.getPlain("DerivativeOfA",f.toGeoElement().getLabel()));
        }
