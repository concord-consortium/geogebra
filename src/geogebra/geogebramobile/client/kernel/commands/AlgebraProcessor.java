...
import geogebra.geogebramobile.client.kernel.arithmetic.BooleanValue;
...
import geogebra.geogebramobile.client.kernel.arithmetic.Parametric;
import geogebra.geogebramobile.client.kernel.arithmetic.Polynomial;
...
import geogebra.geogebramobile.client.kernel.parser.ParseException;
...
*/	
	 ...
	 * @return changed geo
	 */
/*AG	public GeoElement changeGeoElement(
			GeoElement geo,
			String newValue,
	 ...
	 * @return changed geo
	 */
/*AG	public GeoElement changeGeoElementNoExceptionHandling(GeoElement geo, String newValue, boolean redefineIndependent, boolean storeUndoInfo) 
	throws Exception {
	 ...
	 */
/*AG	public double evaluateToDouble(String str) {
		try {
	 ...
	 * Returns null if something went wrong.
	 */
/*AG	public GeoText evaluateToText(String str, boolean createLabel) {
		boolean oldMacroMode = cons.isSuppressLabelsActive();
