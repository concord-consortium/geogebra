 ...
 * @version 12.04.08
 */
/*Agclass CmdFitExp extends CmdOneListFunction{
 ...
 */
/*AGclass CmdFitLineX extends CmdOneListFunction {
 ...
 * adapted from CmdLcm by Michael Borcherds 2008-01-14
 */
/*AGclass CmdFitLineY extends CmdOneListFunction {
...
/*AGclass CmdFitLog extends CmdOneListFunction{
 ...
 * @version 07.04.08
 */
/*AGclass CmdFitPow extends CmdOneListFunction{
 ...
 * @version 15.11.08
 */
/*AGclass CmdFitSin extends CmdOneListFunction{
 ...
 * @version 15.11.08
 */
/*AGclass CmdFitLogistic extends CmdOneListFunction{
 ...
 * @version 2010-02-25
 */
/*AGclass CmdFitGrowth extends CmdOneListFunction{
 ...
 *  Michael Borcherds 2008-04-12
 */
/*AGclass CmdMean extends CmdOneListFunction {
 ...
 */
/*AGclass CmdMedian extends CmdOneListFunction {
 ...
 * Mode[ <List> ]
 */
/*AGclass CmdMode extends CmdOneListFunction {
 ...
 * adapted from CmdLcm by Michael Borcherds 2008-02-16
 */
/*AGclass CmdQ1 extends CmdOneListFunction {
 ...
 * adapted from CmdLcm by Michael Borcherds 2008-02-16
 */
/*AGclass CmdQ3 extends CmdOneListFunction {
 ...
 */
/*AGclass CmdReverse extends CmdOneListFunction {
 ...
 * Michael Borcherds 
 */
/*AGclass CmdInvert extends CmdOneListFunction {
 ...
 * Michael Borcherds 
 */
/*AGclass CmdReducedRowEchelonForm extends CmdOneListFunction {
 ...
 * Michael Borcherds 
 */
/*AGclass CmdTranspose extends CmdOneListFunction {
 ...
 * Michael Borcherds 
 */
/*AGclass CmdDeterminant extends CmdOneListFunction {
 ...
 */
/*AGclass CmdSD extends CmdOneListFunction {
 ...
 * adapted from CmdVariance by Michael Borcherds 2008-02-18
 */
/*AGclass CmdSampleSD extends CmdOneListFunction {
 ...
 * Sort[ <List> ]
 */
/*AGclass CmdSort extends CmdOneListFunction {
 ...
 * Rank[ <List> ]
 */
/*AGclass CmdRank extends CmdOneListFunction {
 ...
 * Shuffle[ <List> ]
 */
/*AGclass CmdShuffle extends CmdOneListFunction {
 ...
 * Shuffle[ <List> ]
 */
/*AGclass CmdRandomElement extends CmdOneListFunction {
 ...
 * PointList[ <List> ]
 */
/*AGclass CmdPointList extends CmdOneListFunction {
 ...
 * PointList[ <List> ]
 */
/*AGclass CmdRootList extends CmdOneListFunction {
 ...
 */
/*AGclass CmdVariance extends CmdOneListFunction {
 ...
 * adapted from CmdSum by Michael Borcherds 2008-02-16
 */
/*AGclass CmdSampleVariance extends CmdOneListFunction {
 ...
 * adapted from CmdSum by Michael Borcherds 2008-02-16
 */
/*AGclass CmdProduct extends CmdOneListFunction {
