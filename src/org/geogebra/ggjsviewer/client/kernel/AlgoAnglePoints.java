...
public class AlgoAnglePoints extends AlgoElement {
    ...
    final public String toString() {
        ...
        if (algoAnglePoly != null) 
            return bApp.getPlain("AngleBetweenABCofD",A.getLabel(),B.getLabel(),C.getLabel(),algoAnglePoly.getPolygon().getNameDescription());
        else
           	return bApp.getPlain("AngleBetweenABC",A.getLabel(),B.getLabel(),C.getLabel());
