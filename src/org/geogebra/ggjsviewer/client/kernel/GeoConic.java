...
// apply {{p,q},{r,s}} to conic			
	...
	*************************************/
	...
	public String getSpecificEquation() {
		  ...
		  switch (type) {
			 case GeoConic.CONIC_CIRCLE:
				 ret = bApp.getPlain("CircleEquation");
				 break;

			 case GeoConic.CONIC_ELLIPSE:
				 ret = bApp.getPlain("EllipseEquation");
				 break;

			 case GeoConic.CONIC_HYPERBOLA:
				 ret = bApp.getPlain("HyperbolaEquation");
				 break;
 
			 case GeoConic.CONIC_PARABOLA:
				 ret = bApp.getPlain("ParabolaEquation");
				 break;        
    
			 case GeoConic.CONIC_DOUBLE_LINE:
				 ret = bApp.getPlain("DoubleLineEquation");
				 break;      
    
			 case GeoConic.CONIC_PARALLEL_LINES:
			 case GeoConic.CONIC_INTERSECTING_LINES:
				 ret = bApp.getPlain("ConicLinesEquation");
				 break;                  
