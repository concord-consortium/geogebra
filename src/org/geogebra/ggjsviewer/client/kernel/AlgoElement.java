...
public abstract class AlgoElement extends ConstructionElement implements EuclidianViewAlgo {
   ...
   //AG private static ResourceBundle rbalgo2command;
	// Added for Intergeo File Format (Yves Kreis) -->
	//AGprivate static ResourceBundle rbalgo2intergeo;
	// <-- Added for Intergeo File Format (Yves Kreis)
     ...
     */
    /*AGfinal public static void initAlgo2CommandBundle(Application app) {
    ...
    /*AGfinal String getCommandString(String classname) {
	...
	// Added for Intergeo File Format (Yves Kreis) -->
    /*AGprivate String getIntergeoString(String classname) {
...
//        updateTime += (endTime - startTime );           
    ...
    public String getCommandDescription() {
        ...
        if (cmdname.equals("Expression"))
            ...
            if (kernel.isTranslateCommandName()) {
                sb.append(bApp.getCommand(cmdname));        
            } else {
                sb.append(cmdname);
            } 
    ...
    String getCommandName() {
        ...
        if (classname.startsWith("AlgoDependent")) {
            ...
            // translate algorithm class name to internal command name
            cmdname = "AlgoElement591";//AGgetCommandString(classname);
        }
        return cmdname;
    }   
   ...
   /*AG String getIntergeoName() {
    ...
    final public String getI2G(int mode) {
        ...
        try {
        	if (mode == CONSTRAINTS) {
    	        // command
    	        String cmdname = "AlgoElement881";//AGgetIntergeoName();
    	        if (!cmdname.equals("Expression"))
