...
public class ConstructionDefaults {
	...
	private int lineThickness = EuclidianViewConstants.DEFAULT_LINE_THICKNESS;
	private int pointSize = EuclidianViewConstants.DEFAULT_POINT_SIZE;
	private int angleSize = EuclidianViewConstants.DEFAULT_ANGLE_SIZE;
...
//		freePoint.setLocalVariableLabel(app.getPlain("Point") + strFree);
		freePoint.setPointSize(EuclidianViewConstants.DEFAULT_POINT_SIZE);
		freePoint.setPointStyle(EuclidianViewConstants.POINT_STYLE_DOT);
...
//		depPoint.setLocalVariableLabel(app.getPlain("Point") + strDependent);
		depPoint.setPointSize(EuclidianViewConstants.DEFAULT_POINT_SIZE);
		depPoint.setPointStyle(EuclidianViewConstants.POINT_STYLE_DOT);
...
//		pathPoint.setLocalVariableLabel(app.getPlain("PointOn"));
		pathPoint.setPointSize(EuclidianViewConstants.DEFAULT_POINT_SIZE);
		pathPoint.setPointStyle(EuclidianViewConstants.POINT_STYLE_DOT);
...
//		regionPoint.setLocalVariableLabel(app.getPlain("PointOn"));
		regionPoint.setPointSize(EuclidianViewConstants.DEFAULT_POINT_SIZE);
		regionPoint.setPointStyle(EuclidianViewConstants.POINT_STYLE_DOT);
		...
		complexPoint.setPointSize(EuclidianViewConstants.DEFAULT_POINT_SIZE);
		complexPoint.setPointStyle(EuclidianViewConstants.POINT_STYLE_DOT);
...
//		list.setLocalVariableLabel(app.getPlain("List"));
	...
	final public void setDefaultVisualStyles(GeoElement geo, boolean isReset) {
        ...
        // label visibility
		int labelingStyle = bApp == null ? LABEL_VISIBLE_USE_DEFAULTS : 
										bApp.getLabelingStyle();
		
		// automatic labelling: 
		// if algebra window open -> all labels
		// else -> no labels
		if (labelingStyle == LABEL_VISIBLE_AUTOMATIC) {
			if(bApp.hasGuiManager()) {
	...
	public void resetDefaults() {
		...
		pointSize = EuclidianViewConstants.DEFAULT_POINT_SIZE;
		angleSize = EuclidianViewConstants.DEFAULT_ANGLE_SIZE;
