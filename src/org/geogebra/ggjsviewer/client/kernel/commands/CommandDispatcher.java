...
public class CommandDispatcher {
   ...
   //AG private MacroProcessor macroProc;
    ...
    protected void initCmdTable() {    	 
    	...
    	//AGcmdTable.put("Derivative", new CmdDerivative(kernel));	   
    	...
    	//AGcmdTable.put("Midpoint", new CmdMidpoint(kernel));	   
    	...
    	//AGcmdTable.put("Intersect", new CmdIntersect(kernel));	   
    	...
    	//AGcmdTable.put("Segment", new CmdSegment(kernel));	   
